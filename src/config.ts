...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "/Images/wallpaper.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	//	},
		{
			...
			url: "https://www.linkedin.com/in/ash-t-james/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Rizosha",
		},
		{
			name: "Itch.io",
